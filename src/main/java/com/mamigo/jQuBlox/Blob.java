...
public class Blob {
	...
	private QBFileObjectAccess remoteBlob=null; 
	...
	public QBFileObjectAccess getRemoteBlob() {
		return remoteBlob;
	}
	public void setRemoteBlob(QBFileObjectAccess remoteBlob) {
	...
	public String getUploadParams(Map<String,String> ret) throws JSONException, UnsupportedEncodingException
	{
		...
		String params=remoteBlob.getParams();
